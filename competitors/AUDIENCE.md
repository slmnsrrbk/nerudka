...
## Варианты v2: каждый отвечает на 20 из 20 вопросов

Страница в Figma: [«Прототипы v2 · по вопросам ЦА»](https://www.figma.com/design/juFVw7SDIxDw0StkPZCTHH/?node-id=150-2). В каждом блоке — аннотация «Отвечает на вопросы: Q..», справа от варианта — его блок-схема. Пробелы закрыты блоками из других вариантов и фактами из `src/data`; v1 не тронуты.

| Вариант | Блоков | Вопросов с ответом | Что изменилось против v1 |
|---|---|---|---|
| П1 v2 · Проверяемый завод | 13 | 20 из 20 | «Короткие ответы»: +3 карточки — зима, запас объёма, самовывоз и скидки (Q12, Q19, Q20, Q13) |
| П2 v2 · Конфигуратор | 11 | 20 из 20 | «Короткие ответы»: +3 карточки — зима, запас объёма, самовывоз и скидки (Q12, Q19, Q20) |
| П3 v2 · Люди и объекты | 13 | 20 из 20 | + «Калькулятор объёма по конструкции» из П5 сразу после марок и цен (Q03, Q19)<br>«Ответы и прямой контакт»: +3 карточки — зима, запас, самовывоз и скидки (Q12, Q13, Q20) |
| П4 v2 · Диспетчерская | 13 | 20 из 20 | «Цены дня» подняты на 3-е место — цена сразу после окна подачи (Q01)<br>+ «Миксер или насос» из П2 (Q06)<br>+ «Короткие ответы» из П1 v2 (Q05, Q07, Q09, Q11, Q13, Q20)<br>+ «Юрлицам» из П2 (Q15, Q16)<br>+ «Объекты» из П2 (Q17) |
| П5 v2 · Каталог по задачам | 14 | 20 из 20 | + «Цифры» из П2 под первым экраном: 6 узлов, от 1 м³, 24/7 (Q08, Q05)<br>+ «Миксер или насос» из П2 (Q06)<br>+ «Короткие ответы» из П1 v2 (Q04, Q10, Q11, Q13, Q20)<br>+ «Объекты» и «Юрлицам» из П2 (Q17, Q15, Q16)<br>Калькулятор: запас 5 % вместо 3 % — как в статье прототипа |
| П6 v2 · Для застройщиков | 10 | 20 из 20 | + «Короткие ответы» из П1 v2 перед менеджером: марка, минимум, разгрузка, зима, запас, самовывоз, скидки<br>Первый экран: «объём посчитаем сами» у загрузки спецификации (Q03) |

## П7 — итоговый вариант: SEO, понятный, продающий

Основа — П1 v2 (лучшее покрытие всех сегментов), плюс калькулятор, гео-ссылки и советы из П5, насос и «Юрлицам» из П2. Отвечает на 20 из 20 вопросов.

| # | Блок | Отвечает на | Зачем / SEO |
|---|---|---|---|
| 00 | `o:00` | Q18 | Одна строка: поиск, корзина, Telegram, MAX, телефон 24/7 — связь в один клик |
| 01 | `o:01` | Q01, Q02, Q03, Q05, Q08, Q09, Q15, Q18 | H1 с основным запросом «бетон с доставкой по Москве и области» (Яндекс: основной запрос — в H1). Продаёт: цена с доставкой до звонка |
| 02 | `o:02` | Q02, Q05, Q06, Q14, Q08, Q09, Q11, Q16, Q15 | Три входа — дом, стройка, закупка: каждый сегмент сразу видит своё; кнопки ведут в разделы сайта |
| 03 | `o:03` | Q01, Q02, Q03 | H2 «Цена бетона за 1 м³»: таблица текстом, от задачи к марке и цене; ссылки на карточки марок |
| 04 | `c:П5v2:04` | Q03, Q01, Q19 | Из П5 — H2 «Калькулятор бетона»: сколько кубов, с запасом 5 % |
| 05 | `c:П2v2:04` | Q06, Q14 | Из П2 — бетононасос с ценой от 18 000 ₽/смена и акцией со сроком |
| 06 | `o:04` | Q01, Q10 | Адрес → зона → цена доставки; карта шести узлов |
| 07 | `c:П5v2:07` | Q01 | Из П5 — 13 ссылок на гео-страницы доставки: внутренние ссылки помогают роботу найти страницы (Яндекс Вебмастер) |
| 08 | `o:05` | Q04, Q06, Q07, Q09, Q02, Q18 | Три шага и срок «заявка до 12:00 — бетон сегодня»; что приедет с машиной |
| 09 | `o:06` | Q05, Q10, Q04, Q09, Q07, Q11, Q02, Q08, Q12, Q19, Q20, Q13 | H2 «Вопросы о бетоне и доставке»: 9 открытых ответов, разметка FAQPage уже есть в прототипе; не гармошка, как у GMR и МосАвтоБетона |
| 10 | `o:07` | Q07, Q08, Q15, Q09 | Доказательства вместо «высокого качества»: ИНН, адреса узлов, весы, лаборатория |
| 11 | `o:09` | Q17, Q14, Q06 | Объекты с цифрами, отзыв внутри объекта, ссылка на рейтинг в Яндекс Картах |
| 12 | `c:П2v2:09` | Q09, Q11, Q15, Q14, Q16 | Из П2 — договор, УПД, отсрочка, протоколы; документы для закупки скачать сразу |
| 13 | `c:П5v2:09` | Q19, Q07, Q09, Q12, Q02 | Из П5 — ссылки на статьи блога: полезный текст и внутренние ссылки вместо SEO-простыни |
| 14 | `o:11` | Q01, Q18 | Одна короткая форма в конце и мессенджеры |
| 15 | `o:12` | — | Каталог, доставка, услуги — ссылками; SEO-текст свёрнут в одну строку |

**SEO — на что опираемся:**
